...
These need to be placed in the `resources/` directory. The images must be named `ski32\_n.bmp`
...
I used \[ResourcesExtract](https://www.nirsoft.net/utils/resources\_extract.html) to extract the bitmaps and icon file.

You will just need to rename `ski32\_ICONSKI.ico` to `iconski.ico` The bitmap files should be named correctly.
